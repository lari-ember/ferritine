...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('max_vehicles_docked', sa.Integer(), nullable=True, server_default='2'),
        sa.Column('has_shelter', sa.Boolean(), nullable=True, server_default='false'),
        sa.Column('has_ticket_office', sa.Boolean(), nullable=True, server_default='false'),
        sa.Column('has_restrooms', sa.Boolean(), nullable=True, server_default='false'),
        sa.Column('condition_percent', sa.Integer(), nullable=True, server_default='100'),
        sa.Column('last_inspection_date', sa.DateTime(), nullable=True),
        sa.Column('created_at', sa.DateTime(), nullable=False),
        sa.Column('updated_at', sa.DateTime(), nullable=True),
        sa.PrimaryKeyConstraint('id'),
        sa.ForeignKeyConstraint(['building_id'], ['buildings.id']),
        sa.CheckConstraint('condition_percent >= 0 AND condition_percent <= 100', name='check_station_condition_range')
    )
